\documentclass[draft]{jsarticle} % pLaTeX を使う場合
...
pdfborder={0 0 0},%
pdftitle={単眼カメラによる動的構造物の三次元計測},%
pdfsubject={2022年度東京大学大学院工学系研究科社会基盤学専攻卒業論文},%
pdfauthor={小林 健},%
pdfkeywords={},%
]{hyperref}%しおり・文書情報
...
\date{2023年2月1日}
\EngTitle{3-Dimensional Measurement of Dynamic Structures\\ Using Monocular Camera}
\department{東京大学 工学部　社会基盤学科}
\id{03-210028}
\author{小林 健}
\ChiefName{布施 孝志 教授}
%\SubChiefName{XXX}
